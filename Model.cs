...
public void ViewReport(string reportName)
{
    ...
    public void EditReport(string reportName, string userName, string product, decimal price, string comments)
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            GeneratePdf(reportName, userName, product, price, comments);
    ...
    public void GeneratePdf(string reportName, string userName, string product, decimal price, string comments)
    {
        try
        {
            ...
            using (var doc = new PdfSharp.Pdf.PdfDocument())
            {
                ...
                yPosition += 30;
                textFormatter.DrawString("Data: " + DateTime.Now.ToString("dd/MM/yyyy"), dataFont, XBrushes.Black, new XRect(20, yPosition, page.Width - 40, page.Height));
                yPosition += 30;
                ...
                OnOperationCompleted(new OperationCompletedEventArgs("Relatório gerado com sucesso.", false));
